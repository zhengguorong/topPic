var config = {
  mongodb_url: process.env.MONGOHQ_URL || 'mongodb://localhost/topPic',
  ...
  topic_cookie: 'Hm_lvt_5256b9d21d9d68644fca1a0db29ba277="1461757571791|1430209263,1430209268,1430209274,1430221362"',
  gaid: 'UA-26476625-4',
};
